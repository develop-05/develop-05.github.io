        ...
        {visible && (
          ...
          >
            <div className={visible ? "all__details_visible" : "all__details"}>
              <div className="detail__air">
                ...
                <div className="air__ticket">
                  ...
                  <span className="economy__class">MARINE ECONOMY</span>
                </div>
              </div>
                ...
                <div className="air__range mt">
                  ...
                  <div className="range__air_loc"><span>15:20</span></div>
                </div>
                ...
                <div className="air__weight">
                  ...
                  <div className="suitcase__weight">
                    ...
                    <div className="suitcase__weight_text">
                      <div><span>AF 2PC-23KG</span></div>
                      <div><span> AC 1PC-40KG</span></div>
                    </div>
                  </div>
                  <div className="suitcase__weight">
              ...
              <div className={visible3 ? "air__more-visible" : "air__more" }>
                <div className="air__fly">
                  ...
                  <span className="fly__text">Outbound Flight on Wed, 28 June</span>
                </div>
              ...
              <div className="air__range ml45">
                  ...
                  <div className="range__air_loc l30"><span>03:40</span></div>
              </div>
            ...
            <div className="rules">
              ...
              <div className="air__range">
                  <div className="range__air_loc">Paris Charles de Gaulle International Airport CDG +1</div>
                  <div className="range__air_loc"><span>05:15</span></div>
              </div>
              ...
              <div className="air__range ml45">
                  ...
                  <div className="range__air_loc l30"><span>15:20</span></div>
              </div>
