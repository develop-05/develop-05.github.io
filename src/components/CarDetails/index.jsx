      ...
      >
        <div className={visible ? "all__details_visible" : "all__details"}>
            ...
            <div className="about__car">
              ...
              <p className="check__in">Pick-up</p>
                ...
                <div className="detail__time max-w3 mt-10 ml-50"> <span className="span__tetx_z">Hertz Athens Airport, 02.08.2021, 14:30AM</span> </div>
                <div className="dotted__line"></div>
              </div>
